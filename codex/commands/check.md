...
- Key Contributions: 「何が新しいか」が具体的か
- Method: 推論手順が記載されているか
...
新規Skill作成の場合: `codex/skills/fix-{domain}/SKILL.md` を作成
...
`codex/skills/topic-{domain}/SKILL.md` に記録:
